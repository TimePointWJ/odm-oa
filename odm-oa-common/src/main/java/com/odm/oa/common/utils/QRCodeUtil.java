...
public class QRCodeUtil {
	...
	/**
	 * 扫码信息采集页面地址+二维码分类(1：运营、2：产品、3：分享)+二维码编号
	 * http://weixin.qq.com/q/KDsoRwLlSesw5GY06RfR?qrCodeType=2&qrCodeId=102 获取二维码类型
	 */
	public static String getQrCodeType(String qrCode) {
		return qrCode.substring(qrCode.indexOf("qrCodeType=") + 11, qrCode.indexOf("&qrCodeId="));
	}

	/**
	 * 获取二维码编号
	 */
	public static String getQrCodeId(String qrCode) {
		return qrCode.substring(qrCode.indexOf("&qrCodeId=") + 10);
	}
